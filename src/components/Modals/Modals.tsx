                        ...
                        <FormControl sx={{ m: 1, minWidth: 150 }}>
                          <Button variant="outlined">
                            <ChildModal
                              ...
                              setStatuList={props.setStatuList}
...
function ChildModal({
  ...
  const [categoryStatuList, setCategoryStatuList] = useState<Status[]>([]);
  ...
  const getAllStatusesByCategory = () => {
    ...
    axios
      ...
      .finally(() => setCategoryStatuList(responselist));
  };
  ...
  const handleSubmit = () => {
    ...
    getAllStatusesByCategory();
    setStatuList({ ...statuList, statuAdd });
  };
      ...
      >
        <Box sx={{ ...style, width: 500 }}>
          ...
          <Box>
            ...
            >
              {categoryStatuList.map((value: any) => (
                <ListItem
                  sx={{ marginTop: "10px" }}
                  key={value.id}
                  disableGutters
